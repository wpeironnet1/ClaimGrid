...
export default function Home(){return <ScrollView style={styles.page} contentContainerStyle={styles.content}>
  ...
  <TouchableOpacity style={styles.button}><Text style={styles.buttonText}>Open research map</Text></TouchableOpacity>
