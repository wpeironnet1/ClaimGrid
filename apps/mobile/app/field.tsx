...
import { createFieldObservation, describeGpsQuality, type FieldObservation, type FieldObservationKind } from "@claimgrid/core";
...
export default function FieldCapture() {
  ...
  async function capture() {
    ...
    try {
      ...
      setRecords(current => [record, ...current]); setNote("");
